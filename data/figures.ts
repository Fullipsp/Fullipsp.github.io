...
.fig('huacheng.webp', 'Hua Cheng<br>Tian Guan Ci Fu','', "owned")
...
.fig('dianxiafigure.webp', 'Dianxia Lucky Fig<br>Tian Guan Ci Fu','', "owned")
.fig('reachheart.webp', 'Until I Reach Your Heart<br>Tian Guan Ci Fu','', "owned")
.fig('amonglotus.webp', 'Among The Lotus<br>Tian Guan Ci Fu','', "owned")
...
.fig('junioreren.webp', 'Eren Yeager','', "owned")
.fig('juniormikasa.webp', 'Mikasa Ackerman','', "owned")
.fig('mikasa.webp', 'Eren Yeager (Season 4)','', "owned")
.fig('eren.webp', 'Eren Yeager (Season 4)','', "owned")
.fig('levi.webp', 'Levi Ackerman', '',"owned")
...
.fig('armin.webp', 'Armin Arlert','', "sold")
