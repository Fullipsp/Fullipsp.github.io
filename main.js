...
addPin('SailorV.jpg', 'Sailor Moon Venus (Fashion Scouts)', "Shipped")
addPin('SailorVMirror.jpg', 'Sailor Moon V <br>(Miracle Mirrors)', "Shipped")
addPin('Nethelenia.jpg', 'Nehelenia <br>(Miracle Mirrors)', "Shipped")
addPin('WickedLadyMirror.jpg', 'Wicked Lady <br>(Miracle Mirrors)', "Shipped")
addPin('BunnyMage.jpg', 'White Mage RPG Series (Original September 2020 Pin Club)', "Shipped")
addPin('BunnyKnight.jpg', 'Prestige Knight RPG Series <br>(Original September 2020 Pin Club)', "Shipped")
...
addPin('BikerRosalina.jpg', 'Mario Kart (Biker) Rosalina <br>(Nintendolls V2)', "Shipped")
addPin('Bowsette.jpg', 'Racer Bowsette (Fashion Fandom October 2020 Pin Club)', "Shipped")
addPin('WeddingPeach.jpg', 'Wedding Peach <br>(Fashion Fandom November 2020 Pin Club)', "Shipped")
addPin('Ahri.jpg', 'Fashion Baddest K/DA Ahri', "Shipped")
addPin('MermaidMoon.jpg', 'Mermaid Moon (Sailor Moon Chibi)', "Shipped")
