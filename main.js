...
addPin('SailorV.jpg', 'Sailor Moon Venus (Fashion Scouts)', "Owned")
addPin('SailorVMirror.jpg', 'Sailor Moon V <br>(Miracle Mirrors)', "Owned")
addPin('WickedLadyMirror.jpg', 'Wicked Lady <br>(Miracle Mirrors)', "Owned")
addPin('BunnyMage.jpg', 'White Mage RPG Series (Original September 2020 Pin Club)', "Owned")
addPin('BunnyKnight.jpg', 'Prestige Knight RPG Series <br>(Original September 2020 Pin Club)', "Owned")
addPin('Zelda.jpg', 'Super Smash Bros. Zelda (Nintendolls V2)', "Owned")
addPin('Rosalina.jpg', 'Original Rosalina (Nintendolls V2)', "Owned")
addPin('BikerRosalina.jpg', 'Mario Kart (Biker) Rosalina <br>(Nintendolls V2)', "Owned")
addPin('Bowsette.jpg', 'Racer Bowsette (Fashion Fandom October 2020 Pin Club)', "Owned")
addPin('Ahri.jpg', 'Fashion Baddest K/DA Ahri', "Owned")
addPin('MermaidMoon.jpg', 'Mermaid Moon (Sailor Moon Chibi) [FOR SALE] ', "Owned")
